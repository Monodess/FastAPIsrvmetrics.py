...
This service receives [data] from 'data_capturer' and reshape it for database model
with engines from 'init_engine'
"""

"""TODO: ORM is already a way to operate data like objects with database integration
